...
export const translations: Dictionary = {
  ...
  "home.cta.title": { EN: "Ready to Bridge Your Future?", JP: "未来を架け橋する準備はできましたか？" },
  "home.cta.subtitle": { EN: "Download the J-Gate corporate brochure — full overview of our services, track record, and partnership model.", JP: "J-Gateの企業パンフレットをダウンロード — サービス、実績、パートナーシップモデルの完全な概要。" },
  ...
  "why.p1.desc": { EN: "Usage permitted for 2 to 4 persons per company — flexible seating sized to your team.", JP: "1社あたり2〜4名まで利用可能 — チーム規模に応じた柔軟な席数。" },
  "why.p2.title": { EN: "Infrastructure Utilization", JP: "インフラ利用" },
  "why.p2.desc": { EN: "Cabinets, Wi-Fi, meeting rooms, and cafeteria spaces — fully equipped for daily operations.", JP: "キャビネット・Wi-Fi・会議室・カフェテリア空間 — 日常業務に完全対応。" },
  "why.p3.title": { EN: "Japan Desk Consultations", JP: "ジャパンデスク相談" },
  "why.p3.desc": { EN: "General multi-topic advisory available entirely in Japanese — no language friction.", JP: "多分野にわたる総合相談を日本語で完全対応 — 言語の壁なし。" },
  "why.p4.title": { EN: "End-to-End Company Setup", JP: "エンドツーエンド設立支援" },
  "why.p4.desc": { EN: "Complete step-by-step guidance up to corporate entity establishment — from concept to registration.", JP: "法人設立までの完全ステップバイステップガイダンス — 構想から登記まで。" },
  "why.p5.title": { EN: "Expert Networking Events", JP: "専門家ネットワーキング" },
  "why.p5.desc": { EN: "Direct participation in networking events with business authorities and local experts.", JP: "ビジネス当局者や現地専門家とのネットワーキングイベントに直接参加。" },
  "why.p6.title": { EN: "India Study Sessions", JP: "インド勉強会" },
  "why.p6.desc": { EN: "Ongoing participation in specialized India market seminars — continuous learning, not one-off.", JP: "専門的なインド市場セミナーへの継続参加 — 単発ではなく継続的学習。" },
  "why.p7.title": { EN: "Talent Hiring & Local Services", JP: "採用支援・現地サービス" },
  "why.p7.desc": { EN: "Support across payroll, outsourcing, direct hiring, translation/interpretation, and meal delivery arrangements (Italian, Chinese, Japanese-style).", JP: "給与計算・アウトソーシング・直接採用・翻訳通訳・食事手配（イタリアン・中華・和食）を包括支援。" },
