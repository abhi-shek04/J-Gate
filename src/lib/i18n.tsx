...
export const translations: Dictionary = {
  ...
  "hero.subtitle": {
    EN: "J-Gate is the dedicated working hub connecting top Indian engineering talent with Japanese enterprises — through recruitment, JLPT/NAT language training, and end-to-end relocation support. Operated by Indobox India Pvt. Ltd. at Cyber Gateway, Hyderabad.",
    JP: "J-Gateは、インドのトップエンジニアリング人材と日本企業を、採用・JLPT/NAT語学研修・エンドツーエンドの再配置サポートで繋ぐ専用ワーキングハブです。Indobox India Pvt. Ltd.がCyber Gateway、ハイデラバードで運営。",
  },
  "hero.jptag": { EN: "日本企業向け専用ワーキングスペースのご案内", JP: "日本企業向け専用ワーキングスペースのご案内" },
  "hero.entag": { EN: "A New Horizon for India-Japan Business Collaboration in Hyderabad", JP: "A New Horizon for India-Japan Business Collaboration in Hyderabad" },
  ...
  "hero.founded": { EN: "Est. June 22, 2026", JP: "2026年6月22日設立" },
